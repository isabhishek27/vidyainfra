...
class Workshops extends FrontendController {
    ...
    public function index() {
		$cond = "`slug`='workshop' AND `status` = 1 ";
        ...
        $data['meta_title'] = (isset($meta_info->meta_title) && !empty($meta_info->meta_title))?$meta_info->meta_title:'Workshops';
        $data['meta_desc'] = (isset($meta_info->meta_desc) && !empty($meta_info->meta_desc))?$meta_info->meta_desc:'Workshops';
    ...
    public function details(){
        ...
        $data['meta_title'] = (isset($records->meta_title))?$records->meta_title:$records->name;
        $data['meta_desc'] = (isset($records->meta_desc))?$records->meta_desc:$records->name;
