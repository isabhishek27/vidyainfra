                ...
                <div class="page-header">
                 ...
                 <!-- Default Basic Forms Start -->
					<div class="pd-20 card-box mb-30">
						...
						<?php echo form_open_multipart('admin/photoadventure/add');?>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<select class="form-control" name="is_home">
										...
										<option value="1" <?php echo ($is_home=1)?'selected':'';?>>Yes</option>
										<option value="0" <?php echo ($is_home=0)?'selected':'';?>>No</option>	
									</select>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<select class="form-control" name="is_menu">
										<option value="">Select One</option>
										<option value="1" <?php echo ($is_menu=1)?'selected':'';?>>Yes</option>
										<option value="0" <?php echo ($is_menu=0)?'selected':'';?>>No</option>	
									</select>
								</div>
							</div>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<textarea class="form-control border-radius-0" id="cmscontainer" rows="6" placeholder="About Photo Adventure" name="content"><?php echo set_value('content');?></textarea>
