                ...
                <div class="page-header">
                 ...
                 <!-- Default Basic Forms Start -->
					<div class="pd-20 card-box mb-30">
						...
						<?php echo form_open_multipart('admin/faq/edit/'.$row->id);?>
                            <input type="hidden" name="id" value="<?php echo $row->id;?>">
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Question</label>
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Question" name="question" value="<?php echo set_value('question',$row->question);?>"/>                                   
                                    <small class="text-danger"><?php echo isset($validation['question']) ? $validation['question'] : null;  ?></small>
								</div>
							</div>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<textarea class="form-control" name="answer" rows="6"><?php echo set_value('answer',$row->answer);?></textarea>
                                    <small class="text-danger"><?php echo isset($validation['answer']) ? $validation['answer'] : null;  ?></small>
								</div>
							</div>
                           ...
                           <div class="modal-footer">
                            ...
                            <a href="<?php echo site_url('admin/faq');?>" class="btn btn-warning">Cancel</a>
                            </button>
                        </div>
