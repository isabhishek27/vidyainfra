                ...
                <div class="page-header">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo site_url('admin/photographar');?>">Photographars</a>
                                    </li>
                 ...
                 <!-- Default Basic Forms Start -->
					<div class="pd-20 card-box mb-30">
						...
						<?php echo form_open_multipart('admin/photographar/add');?>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Region" name="region" value="<?php echo set_value('region');?>"/>                                   
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Facebook Link" name="fb_link" value="<?php echo set_value('fb_link');?>"/>                                   
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Instagram Link" name="insta_link" value="<?php echo set_value('insta_link');?>"/>                                   
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="X Link" name="x_link" value="<?php echo set_value('x_link');?>"/>                                   
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Linkedin Link" name="linkedin_link" value="<?php echo set_value('linkedin_link');?>"/>                                   
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<textarea class="form-control" rows="6" placeholder="About Photographar" name="about" id="cmscontainer"><?php echo set_value('about');?></textarea>
