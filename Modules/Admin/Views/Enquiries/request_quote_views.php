        ...
        <div class="pd-ltr-20">
            ...
            <div class="card-box mb-20 dataTables_wrapper dt-bootstrap4 pb-20 pt-20">
                ...
                <div class="row mb-20">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <?php echo form_open('admin/enquiries/requestquote','method="get"');?>
                ...
                ?>
                <?php echo form_open('admin/enquiries/requestquote','id="form_listing"');?>
                ...
                <table class="table nowrap table-stripedt">
                    <thead>
                        <tr>
                            ...
                            <!-- <th style="width: 10%;">Travel Location</th> -->
                    ...
                    <tbody>
                        ...
                        foreach($result as $k=>$row){
                            ...
                            <tr>
                                ...
                                <!-- <td><?php echo $row->travel_location;?></td> -->
                                ...
                                <td style="text-align: center;">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item" href="<?php echo site_url('admin/enquiries/requestquote_delete/'.$row->id);?>" onclick="return confirm('Are you sure? You want to delete this record?');"><i
            ...
            <div class="modal" id="modal-detail">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle"><span id="pageTitle">Request a Quote Enquiry Details</span></h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                                data-toggle="tooltip" data-placement="bottom" title=""
                                data-original-title="Close Modal">
                                <span aria-hidden="true">×</span>
                        ...
                        <div class="modal-body">
                            <table class="table">
                                <tr>
                                    <td class="col-md-2 b">Fist Name</td>
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-9"><span id="first_name"></span></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2 b">Last Name</td>
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-9"><span id="last_name"></span></td>
                                </tr>                               
                                 <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-9"  id="workshop"></td>
                                </tr>
                                
                                <tr>
                                    <td class="col-md-2 b">Comments</td>
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-9"  id="travel_location"></td>
                                </tr>
                                <tr>
