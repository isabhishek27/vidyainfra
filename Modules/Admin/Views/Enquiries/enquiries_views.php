        ...
        <div class="pd-ltr-20">
            ...
            <div class="card-box mb-20 dataTables_wrapper dt-bootstrap4 pb-20 pt-20">
                ...
                <div class="row mb-20">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <?php echo form_open($list_url,'method="get"');?>
                ...
                ?>
                <?php echo form_open($list_url,'id="form_listing"');?>
                ...
                <table class="table nowrap table-stripedt">
                    <thead>
                        <tr>
                            ...
                            <?php if(!empty($show_vehicle)){ ?>
                            <th style="width: 15%;">Vehicle Interested</th>
                            <?php } ?>
                    ...
                    <tbody>
                        ...
                        foreach($result as $k=>$row){
                            ...
                            <tr>
                                ...
                                <td><h5 class="font-14"><?php echo $row->first_name;?> <?php echo $row->last_name;?></h5></td>
                                <td><h5 class="font-14"><?php echo $row->mobile_number;?></h5></td>
                                <td><h5 class="font-14"><?php echo $row->email;?></h5></td>
                                <?php if(!empty($show_vehicle)){ ?>
                                <td><h5 class="font-14"><?php echo !empty($row->address)?esc($row->address):'—';?></h5></td>
                                <?php } ?>
                                <td><h5 class="font-14"><?php echo $row->created_at;?></h5></td>
                                <td>
                                    <?php
                                    ...
                                    ?>
                                    <span class="badge badge-success">New Enquireis</span>
                                    <?php
                                    }
                                    ?>
                                </td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <!-- <a class="dropdown-item" href="javascript:;" data-toggle="modal"
                                                ...
                                                <i class="dw dw-eye"></i>
                                                View Details</a> -->
                                             <a class="dropdown-item ViewInDetail" href="javascript:;" data-section="enquiriesDetail" data-rec-id="<?php echo $row->id;?>"><i class="dw dw-eye"></i>View Details</a>                                              


                                            <a class="dropdown-item" href="<?php echo site_url('admin/enquiries/enquiries_delete/'.$row->id);?>" onclick="return confirm('Are you sure? You want to delete this record?');"><i
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <select class="form-control" name="reply_status">
                                                                ...
                                                                <option value='1' <?php echo ($reply_status==1)?'selected':'';?>>Replied</option>
                                                                <option value='0' <?php echo ($reply_status==0)?'selected':'';?>>Not Replied</option>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table">
                                <tr>
                                    <td class="col-md-2 b">Name</td>
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-9"><span id="fname"></span> <span id="lname"></span></td>
                                </tr>                               
                                 <tr>
                                    <td class="col-md-2 b">Mobile</td>
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-9" id="mobile"></td>
                                </tr>
                                 <tr>
                                    <td class="col-md-2 b">Email</td>
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-9"  id="email"></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2 b"><?php echo !empty($show_vehicle) ? 'Vehicle Interested' : 'Address';?></td>
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-9"  id="address"></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2 b">Enquiry Date</td>
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-9" id="enquiry_date"></td>
                                </tr>
                                 <tr>
                                    <td class="col-md-2 b">Message</td>
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-9" id="message"></td>
                                </tr>
                            </table>
