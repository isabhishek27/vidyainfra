        ...
        <div class="pd-ltr-20">
            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 text-right">
                        ...
                        <a href="<?php echo site_url('admin/cms/add_category');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>        
            ...
            <div class="card-box mb-20 dataTables_wrapper dt-bootstrap4 pb-20 pt-20">
                ...
                <div class="row mb-20">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <?php echo form_open('admin/cms/categories','method="get"');?>
                ...
                ?>
                <?php echo form_open('admin/cms/categories','id="form_listing"');?>
                    ...
                    <tbody>
                        ...
                        foreach($result as $k=>$row){
                            ...
                            <tr>
                                ...
                                <td><h5 class="font-16"><?php echo $row->cat_name;?></h5></td>
                                <td>
                                    <?php
                                    if($row->status==1){
                                    ?>
                                ...
                                <td style="text-align: center;">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item" href="<?php echo site_url('admin/cms/edit_category/'.$row->id);?><?php echo (($curr_paging)!=NULL)?'?page='.$curr_paging:'';?>">
                                                <i class="dw dw-pencil"></i>
                                                Edit</a>


                                            <a class="dropdown-item" href="<?php echo site_url('admin/cms/category_delete/'.$row->id);?>" onclick="return confirm('Are you sure? You want to delete this record?');"><i
