                ...
                <div class="page-header">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo site_url('admin/cms');?>">CMS Pages</a>
                                    </li>
                 ...
                 <!-- Default Basic Forms Start -->
					<div class="pd-20 card-box mb-30">
						...
						<?php echo form_open('admin/cms/edit_page/'.$row->page_id);?>
                            <input type="hidden" name="page_id" value="<?php echo $row->page_id;?>">

                            <div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Page Name</label>
                            ...
                            <div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Page Description</label>
								<div class="col-sm-12 col-md-10 html-editor33">
									<textarea name="page_content" id="cmscontainer" style="height: 200px;"
                                                            class="textarea_editor22 form-control border-radius-0"
                                                            placeholder="Enter text ..."><?php echo set_value('page_content',$row->page_content);?></textarea>
                                    <small class="text-danger"><?php echo isset($validation['page_content']) ? $validation['page_content'] : null;  ?></small>
								</div>
							</div>
                           ...
                           <div class="modal-footer">
                            ...
                            <a href="<?php echo site_url('admin/cms');?>" class="btn btn-warning">Cancel</a>
                            </button>
                        </div>
