                ...
                <div class="page-header">
                 ...
                 <!-- Default Basic Forms Start -->
					<div class="pd-20 card-box mb-30">
						...
						<?php echo form_open_multipart('admin/coupon/add');?>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Coupon Name</label>
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Coupon Name" name="coupon_title" value="<?php echo set_value('coupon_title');?>"/>                                   
                  <small class="text-danger"><?php echo isset($validation['coupon_title']) ? $validation['coupon_title'] : null;  ?></small>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Coupon Code" name="coupon_code" value="<?php echo set_value('coupon_code');?>"/>                                   
                  <small class="text-danger"><?php echo isset($validation['coupon_code']) ? $validation['coupon_code'] : null;  ?></small>
							...
							<div class="form-group row">								
								...
								<div class="col-sm-12 col-md-10">
									<?php $sel_coupon_type = set_value('coupon_type');?>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Coupon Discount" name="coupon_discount" value="<?php echo set_value('coupon_discount');?>"/>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control date-picker2" type="text" placeholder="Start date" name="start_date" value="<?php echo set_value('start_date');?>"/>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control date-picker2" type="text" placeholder="End date" name="end_date" value="<?php echo set_value('end_date');?>"/>
