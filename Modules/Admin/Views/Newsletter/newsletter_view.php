    ...
    <div class="main-container">
        <div class="pd-ltr-20">
            ...
            <div class="card-box mb-20 dataTables_wrapper dt-bootstrap4 pb-20 pt-20">
                ...
                <div class="row mb-20">
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="dt-buttons btn-group flex-wrap">
                            ...
                            <button class="btn btn-outline-primary action" data-id="subscribe" tabindex="0" aria-controls="DataTables_Table_2" type="button" ><span>Subscribe</span></button>

                            <button class="btn  btn-outline-primary action" data-id="unsubscribe" tabindex="0" aria-controls="DataTables_Table_2"
                                type="button" ><span>Unsubscribe</span></button>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <?php echo form_open('admin/newsletter','method="get"');?>
                ...
                ?>
                <?php echo form_open('admin/newsletter','id="form_listing"');?>
                    ...
                    <tbody>
                        ...
                        foreach($result as $k=>$row){
                            ...
                            <tr>
                                ...
                                <td><h5 class="font-16"><?php echo $row->name;?></h5></td>
                                <td><h5 class="font-16"><?php echo $row->email;?></h5></td>
                                ...
                                <td style="text-align: center;">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item" href="<?php echo site_url('admin/newsletter/delete/'.$row->id);?>" onclick="return confirm('Are you sure? You want to delete this record?');"><i
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <select class="form-control" name="is_subscribed">
                                                                ...
                                                                <option value='1' <?php echo ($status==1)?'selected':'';?>>Subscribed</option>
                                                                <option value='0' <?php echo ($status==0)?'selected':'';?>>Unsubscribed</option>
