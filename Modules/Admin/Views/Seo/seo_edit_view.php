                ...
                <div class="page-header">
                 ...
                 <!-- Default Basic Forms Start -->
					<div class="pd-20 card-box mb-30">
						...
						<?php echo form_open_multipart('admin/seo/edit/'.$row->id);?>
                            <input type="hidden" name="id" value="<?php echo $row->id;?>">

                            <div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Page Name</label>
								<div class="col-sm-12 col-md-10">
                                    <?php $page_name = set_value('page_name',$row->slug);?>
									<select class="form-control" id="page_name" name="page_name">
                                        <option value="">Select Page</option>
                                        <?php
                                        foreach($page_name_arr as $pgk=>$pgv){
                                            $sel = ($pgk==$page_name)?'selected':'';
                                            echo '<option value="'.$pgk.'" '.$sel.'>'.$pgv.'</option>';
                                        }
                                        ?>    
                                    </select>
                                    <small class="text-danger"><?php echo isset($validation['page_name']) ? $validation['page_name'] : null;  ?></small>
								</div>
							</div>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<textarea class="form-control" name="meta_desc" rows="6"><?php echo set_value('meta_desc',$row->meta_desc);?></textarea>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<textarea class="form-control" name="meta_keyword" rows="6"><?php echo set_value('meta_keyword',$row->meta_keyword);?></textarea>
                           ...
                           <div class="modal-footer">
                            ...
                            <a href="<?php echo site_url('admin/seo');?>" class="btn btn-warning">Cancel</a>
                            </button>
                        </div>
