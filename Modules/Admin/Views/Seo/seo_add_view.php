                ...
                <div class="page-header">
                 ...
                 <!-- Default Basic Forms Start -->
					<div class="pd-20 card-box mb-30">
						...
						<?php echo form_open_multipart('admin/seo/add');?>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Page Name</label>
								<div class="col-sm-12 col-md-10">
                                    <?php $page_name = set_value('page_name');?>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<textarea class="form-control" name="meta_desc" rows="6"><?php echo set_value('meta_desc');?></textarea>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<textarea class="form-control" name="meta_keyword" rows="6"><?php echo set_value('meta_keyword');?></textarea>
