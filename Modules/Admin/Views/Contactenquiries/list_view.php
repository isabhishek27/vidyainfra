...
<?= form_open('admin/contact-enquiries','method="get" class="mb-3"') ?>
...
<?= form_close() ?>
<table class="table table-striped"><thead><tr><th>ID</th><th>Name</th><th>Phone</th><th>Email</th><th>Type</th><th>Status</th><th>Date</th><th></th></tr></thead><tbody>
...
<td>
<a class="btn btn-sm btn-primary" href="<?= site_url('admin/contact-enquiries/view/'.$row['id']) ?>">View</a>
<a class="btn btn-sm btn-danger" href="<?= site_url('admin/contact-enquiries/delete/'.$row['id']) ?>" onclick="return confirm('Delete?')">Delete</a>
</td>
</tr>
<?php endforeach; ?>
</tbody></table>
