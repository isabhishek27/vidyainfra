        ...
        <div class="pd-ltr-20">
            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 text-right">
                        ...
                        <a href="<?php echo site_url('admin/workshopgallery/add');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>        
            ...
            <div class="card-box mb-20 dataTables_wrapper dt-bootstrap4 pb-20 pt-20">
                ...
                <div class="row mb-20">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <?php echo form_open('admin/workshopgallery','method="get"');?>
                ...
                ?>
                <?php echo form_open('admin/workshopgallery','id="form_listing"');?>
                ...
                <table class="table nowrap table-stripedt">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 30%;">Gallery Name</th>														
                    ...
                    <tbody>
                        ...
                        foreach($result as $k=>$row){
                            ...
                            <tr>
                                ...
                                <td>
																	<div class="font-14"><?php echo $row->name;?> </div> 
																</td>                                
                                <td>
                                    <?php
                                    ...
                                    ?>
																...
																<td><div class="font-14"><?php echo $row->workshop_name;?></div></td>
                                ...
                                <td style="text-align: center;">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item" href="<?php echo site_url('admin/workshopgallery/edit/'.$row->id);?><?php echo (($curr_paging)!=NULL)?'?page='.$curr_paging:'';?>">
                                                <i class="dw dw-pencil"></i>
                                                Edit</a>


                                            <a class="dropdown-item" href="<?php echo site_url('admin/workshopgallery/delete/'.$row->id);?>" onclick="return confirm('Are you sure? You want to delete this record?');"><i
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Keyword</label>
                                                        <div>
                                                            <input type="text" name="keyword" value="<?php echo $keyword;?>" class="form-control" placeholder="Workshop Name">
                                                        </div>
                                                    </div>
                                                </div>
