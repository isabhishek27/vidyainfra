        ...
        <div class="pd-ltr-20">
            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 text-right">
                        ...
                        <a href="<?php echo site_url('admin/workshop/add');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>        
            ...
            <div class="card-box mb-20 dataTables_wrapper dt-bootstrap4 pb-20 pt-20">
                ...
                <div class="row mb-20">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <?php echo form_open('admin/workshop','method="get"');?>
                ...
                ?>
                <?php echo form_open('admin/workshop','id="form_listing"');?>
                ...
                <table class="table nowrap table-stripedt">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 30%;">Workshop Details</th>														
                            <th style="width: 30%;">Fee</th>
														<th style="width: 10%;">Image</th>
														<th style="width: 10%;">Photographers</th>
                    ...
                    <tbody>
                        ...
                        foreach($result as $k=>$row){
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="font-14">Workshop Title: </div> <?php echo $row->name;?>
                                    <div class="font-14">Total Students Allowed: <?php echo $row->total_seat;?></div>
                                    <div class="font-14">Total Booked Seat: <?php echo $row->total_booked_seat;?></div>
                                    <!-- <div class="font-14">Total Booked Seat: <?php echo $row->total_available_seat;?></div> -->
                                    <div class="font-14">Location: <?php echo $row->workshop_location;?></div>
                                    <div class="font-14">Workshop Start Date: <?php echo $row->workshop_date;?></div>
                                    <div class="font-14">Workshop End Date: <?php echo $row->workshop_end_date;?></div>
                                </td>                                
                                <td>
                                    <div class="font-14">Full Payment: <?php echo $row->full_payment;?></div>
                                    <div class="font-14">Discounted Payment: <?php echo $row->full_payment_discounted;?></div>
                                    <div class="font-14">Down Payment: <?php echo $row->down_payment;?></div>
                                </td>
																 <td>
                                    <?php
                                    ...
                                    ?>
																...
																<td><div class="font-14"><?php echo $row->photographar_name;?></div></td>
                                ...
                                <td style="text-align: center;">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item" href="<?php echo site_url('admin/workshop/edit/'.$row->id);?><?php echo (($curr_paging)!=NULL)?'?page='.$curr_paging:'';?>">
                                                <i class="dw dw-pencil"></i>
                                                Edit</a>


                                            <a class="dropdown-item" href="<?php echo site_url('admin/workshop/delete/'.$row->id);?>" onclick="return confirm('Are you sure? You want to delete this record?');"><i
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Keyword</label>
                                                        <div>
                                                            <input type="text" name="keyword" value="<?php echo $keyword;?>" class="form-control" placeholder="Workshop Title">
                                                        </div>
                                                    </div>
                                                </div>
