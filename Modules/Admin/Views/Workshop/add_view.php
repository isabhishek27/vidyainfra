                ...
                <div class="page-header">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo site_url('admin/workshop');?>">Workshop</a>
                                    </li>
                 ...
                 <!-- Default Basic Forms Start -->
					<div class="pd-20 card-box mb-30">
						...
						<?php echo form_open_multipart('admin/workshop/add');?>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Workshop Title</label>
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Workshop Title" name="name" value="<?php echo set_value('name');?>"/>                                   
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Total Students Allowed" name="total_seat" value="<?php echo set_value('total_seat');?>"/>                                   
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Full Payment" name="full_payment" value="<?php echo set_value('full_payment');?>"/>                                   
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Discounted Full Payment" name="full_payment_discounted" value="<?php echo set_value('full_payment_discounted');?>"/>                                   
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Downpayment" name="down_payment" value="<?php echo set_value('down_payment');?>"/>                                   
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Workshop Location" name="workshop_location" value="<?php echo set_value('workshop_location');?>"/>                                   
							...
							<div class="form-group row">								
								...
								<div class="col-sm-12 col-md-10">
									<?php $sel_photographar = set_value('photographar_id');?>
									<select class="form-control" name="photographar_id" multiselect>
							...
							<div class="form-group row">								
								...
								<div class="col-sm-12 col-md-10">
									<?php 
									$sel_photographers = set_value('photographar_id'); 
									$sel_photographers = is_array($sel_photographers) ? $sel_photographers : [];
									?>
									...
									<select class="selectpicker form-control" name="photographar_id[]" multiple data-live-search="true">
										...
										if (is_array($photographars) && count($photographars) > 0) {
											foreach ($photographars as $pk => $pv) {
												$psel = in_array($pv->id, $sel_photographers) ? 'selected' : '';
												echo '<option value="'.$pv->id.'" '.$psel.'>'.$pv->name.'</option>';
											}
										}
										?>
									...
									<small class="text-danger">										
										<?php echo isset($validation['photographar_id']) ? $validation['photographar_id'] : null;  ?>
									</small>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control date-picker2" type="text" placeholder="Workshop Start Date" name="workshop_date" value="<?php echo set_value('workshop_date');?>"/>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control date-picker2" type="text" placeholder="Workshop End Date" name="workshop_end_date" value="<?php echo set_value('workshop_end_date');?>"/>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<textarea class="form-control" id="cmscontainer" rows="10" placeholder="About Workshop" name="workshop_desc"><?php echo set_value('workshop_desc');?></textarea>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<textarea class="form-control" id="itinerary" rows="10" placeholder="About Workshop" name="workshop_itinerary"><?php echo set_value('workshop_itinerary');?></textarea>
