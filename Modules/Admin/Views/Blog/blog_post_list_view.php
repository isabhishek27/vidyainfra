        ...
        <div class="pd-ltr-20">
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-6">
                     ...
                     <div class="col-md-4 col-sm-6 text-right">
                        ...
                        <a href="<?php echo site_url('admin/blog/post_add');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>        
            ...
            <div class="card-box mb-20 dataTables_wrapper dt-bootstrap4 pb-20 pt-20">
                ...
                <div class="row mb-20">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <?php echo form_open('admin/blog/post','method="get"');?>
                ...
                ?>
                <?php echo form_open('admin/blog/post','id="form_listing"');?>
                    ...
                    <tbody>
                        ...
                        foreach($result as $k=>$row){
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="font-16"><?php echo $row->b_title;?></h5>
                                    <div style="padding-top:10px;"><b>Post Date:</b><?php echo $row->created_at;?></div>
                                </td>
                                <td>
                                    <?php
                                     ...
                                     if(is_file($img_dir_path)){
                                        ...
                                        echo '<img src="'.$img_url_path.'" width="150" height="150" alt="">';
                                     }else{
                                ...
                                <td style="text-align: center;">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item ViewInDetail" href="javascript:;" data-section="postDetail" data-rec-id="<?php echo $row->id;?>"><i class="dw dw-eye"></i>View Details</a>


                                            <a class="dropdown-item" href="<?php echo site_url('admin/blog/post_edit/'.$row->id);?><?php echo (($curr_paging)!=NULL)?'?page='.$curr_paging:'';?>"><i class="dw dw-pencil"></i>Edit</a>
                                                        ...
                                                        <div>
                                                            <select class="form-control" name="category_id">
                                                                ...
                                                                foreach($categories as $ck=>$cv){
                                                                    ...
                                                                    echo '<option value="'.$cv->id.'" '.$sel.'>'.$cv->b_title.'</option>';
                                                                }
                                                                ?>
            ...
            <div class="modal" id="modal-detail">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle"><span id="postTitle">Page Name</span></h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                                data-toggle="tooltip" data-placement="bottom" title=""
                                data-original-title="Close Modal">
                                <span aria-hidden="true">×</span>
                        ...
                        <div class="modal-body">
                            <div class="task-list-form" id="postDesc">Post Details</div>
                        </div>
                        <div class="modal-footer">
