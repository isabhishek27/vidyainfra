                ...
                <div class="page-header">
                 ...
                 <!-- Default Basic Forms Start -->
					<div class="pd-20 card-box mb-30">
						...
						<?php echo form_open_multipart('admin/blog/post_add');?>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Post Name</label>
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Post name" name="b_title" value="<?php echo set_value('b_title');?>"/>                                   
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10 html-editor">
									<textarea name="b_content" id="cmscontainer" style="height: 200px;"
                                                            ...
                                                            placeholder="Enter text ..."><?php echo set_value('b_content');?></textarea>
