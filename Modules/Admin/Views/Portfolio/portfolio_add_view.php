						...
						<?php echo form_open_multipart('admin/portfolio/add');?>
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Portfolio Title" name="title" value="<?php echo set_value('title');?>"/>                                   
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">									
                                    <textarea class="form-control" name="tags" style="height: 100px;"><?php echo set_value('tags');?></textarea>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">									
                                    <textarea class="form-control" name="description" style="height: 100px;"><?php echo set_value('description');?></textarea>
