                ...
                <div class="page-header">
                 ...
                 <!-- Default Basic Forms Start -->
					<div class="pd-20 card-box mb-30">
						...
						<?php echo form_open_multipart('admin/reviews/edit/'.$row->id);?>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="text" placeholder="Email" name="email" value="<?php echo set_value('email',$row->email);?>"/>
                             ...
                             <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<select class="form-control" name="testimonial_rating">
                                       ...
                                       <?php
                                       for($i=1;$i<=5;$i++){
                                        $selected = ($row->testimonial_rating == $i)?'selected':'';
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<textarea class="form-control" name="testimonial" style="height: 100px;"><?php echo set_value('testimonial',$row->testimonial);?></textarea>
