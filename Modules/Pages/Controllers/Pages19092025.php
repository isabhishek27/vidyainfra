...
class Pages extends FrontendController {
    ...
    public function about(){        
        ...
        $data['meta_title']		= $pg_data->page_title;
    ...
    public function post_request_a_quote(){
        if ($this->request->isAJAX()) {
            $first_name = $this->request->getPost('ffirst_name');
            $last_name = $this->request->getPost('flast_name');
            $email = $this->request->getPost('femail');
            $mobile_number = $this->request->getPost('fmobile_number');                        
            $workshop = $this->request->getPost('fworkshop');
            $travel_location = $this->request->getPost('ftravel_location');
